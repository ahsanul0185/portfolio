...
export default function AnimatedCopy({children, colorInitial = "#333", colorAccent = "#bff747", colorFinal = "#ffffff"} : IAnimatedCopyProps) {
    ...
    useGSAP(() => {
        ...
        if (containerRef.current.hasAttribute('data-animated-copy-wrapper')) {
